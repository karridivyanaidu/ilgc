...
function renderHome() {
    document.getElementById("greetingText").textContent = `Welcome back, ${mentorName} 👋`;
    document.getElementById("greetingSub").textContent = `ILGC Mentor · ${userId}`;
...
function renderProfile() {
    document.getElementById("profileAvatar").textContent = mentorName.replace("Dr. ", "").charAt(0);
    document.getElementById("profileName").textContent = mentorName;
    document.getElementById("profileMeta").textContent = "ILGC Mentor";

...
if (role === "faculty") {
    roleTitle.textContent = "Faculty Mentor Login";
    roleDescription.textContent = "Login to access your faculty mentor dashboard";
}
else if (role === "ilgc") {
    roleTitle.textContent = "ILGC Mentor Login";
    roleDescription.textContent = "Login to access the ILGC management portal";
}
